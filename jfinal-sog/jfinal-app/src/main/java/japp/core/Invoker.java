...
import static japp.libs.F.Promise;
...
public class Invoker {
     ...
     */
    static {
        int core = Integer.parseInt(JApp.configuration.getProperty(InitConst.POOL, JApp.mode == JApp.Mode.DEV ? "1" : ((Runtime.getRuntime().availableProcessors() + 1) + "")));
