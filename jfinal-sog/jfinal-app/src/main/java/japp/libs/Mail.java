...
public class Mail {
    ...
    public static Future<Boolean> send(Email email) {
        try {
            ...
            if (JApp.configuration.getProperty("mail.smtp", "").equals("mock") && JApp.mode == JApp.Mode.DEV) {
                Mock.send(email);
    ...
    public static Email buildMessage(Email email) throws EmailException {
        ...
        String from = JApp.configuration.getProperty("mail.smtp.from");
    ...
    public static Session getSession() {
        if (session == null) {
            ...
            props.put("mail.smtp.host", JApp.configuration.getProperty("mail.smtp.host", "localhost"));

            String channelEncryption;
            if (JApp.configuration.containsKey("mail.smtp.protocol") && JApp.configuration.getProperty("mail.smtp.protocol", "smtp").equals("smtps")) {
                // Backward compatibility before stable5
                channelEncryption = "starttls";
            } else {
                channelEncryption = JApp.configuration.getProperty("mail.smtp.channel", "clear");
            }
            ...
            if (JApp.configuration.containsKey("mail.smtp.localhost")) {
                props.put("mail.smtp.localhost", JApp.configuration.get("mail.smtp.localhost"));            //override defaults
            }
            if (JApp.configuration.containsKey("mail.smtp.socketFactory.class")) {
                props.put("mail.smtp.socketFactory.class", JApp.configuration.get("mail.smtp.socketFactory.class"));
            }
            if (JApp.configuration.containsKey("mail.smtp.port")) {
                props.put("mail.smtp.port", JApp.configuration.get("mail.smtp.port"));
            }
            String user = JApp.configuration.getProperty("mail.smtp.user");
            String password = JApp.configuration.getProperty("mail.smtp.pass");
            if (password == null) {
                // Fallback to old convention
                password = JApp.configuration.getProperty("mail.smtp.password");
            }
            session = null;
            ...
            if (Boolean.parseBoolean(JApp.configuration.getProperty("mail.debug", "false"))) {
