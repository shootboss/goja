...
public class Controller extends com.jfinal.core.Controller {
    ...
    public void render(String view) {
        ...
        super.render((view.startsWith(StringPool.SLASH) && JApp.setViewPath)
                ? JApp.viewPath + view.replaceFirst(StringPool.SLASH, StringPool.EMPTY)
                : view);
    ...
    public void setFlash(String key, Object value) {
        ...
        JApp.flashManager().setFlash(this.getSession(false), actionPath, key, value);
        flashflag = true;
    }
    ...
    public void forwardAction(String actionUrl) {
        if (flashflag) {//若有新加入的Flash。更换key。
            ...
            JApp.flashManager().updateFlashKey(this.getSession(false), actionPath, actionUrl);
            flashflag = false;
        }
    ...
    public void redirect(String url) {
        if (flashflag) {
            ...
            JApp.flashManager().updateFlashKey(this.getSession(false), actionPath, newActionPath);
            flashflag = false;
        }
        super.redirect(url);
    }
