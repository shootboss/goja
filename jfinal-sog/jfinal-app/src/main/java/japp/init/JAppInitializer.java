...
import static japp.init.InitConst.DEV_MODE;
 ...
 * @since JDK 1.6
 */
public class JAppInitializer implements ServletContainerInitializer {

    private static final Logger logger = LoggerFactory.getLogger(JAppInitializer.class);
    ...
    public void onStartup(Set<Class<?>> classSet, ServletContext ctx)
        ...
        jfinalFilter.setInitParameter("configClass", "japp.JApp");
