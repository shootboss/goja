package goja.app.test.ci;

import goja.app.StringPool;
import goja.kits.lang.ObjectKit;
...
import static goja.app.StringPool.EMPTY;
...
public final class Profiler {
    ...
    private static Step getCurrentStep() {
        Step subStep = stepThreadLocal.get();
        Step step = null;
    ...
    public static final class Step {
        ...
        private Step getUnreleasedStep() {
            ...
            if (!subStepList.isEmpty()) {
                subStep = subStepList.get(subStepList.size() - 1);
        ...
        private void toString(StringBuilder buffer, String prefix1, String prefix2) {
            ...
            if (isReleased()) {
                ...
                buffer.append(" start:").append(numberFormat.format(getStartCostTime())).append("ms ");
            ...
            for (int i = 0; i < subStepList.size(); i++) {
                Step subStep = subStepList.get(i);
