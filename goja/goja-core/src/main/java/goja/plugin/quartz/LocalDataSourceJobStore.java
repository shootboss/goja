...
public class LocalDataSourceJobStore extends JobStoreCMT {
     ...
     */
    public static final String TX_DATA_SOURCE_PREFIX = "jappTxDataSource.";
     ...
     * @see org.quartz.utils.DBConnectionManager#addConnectionProvider
     */
    public static final String NON_TX_DATA_SOURCE_PREFIX = "jappNonTxDataSource.";
