...
public class FnKit {
    ...
    public static int datediff(interval interval, Date datetime1, Date datetime2) {
        ...
        if (interval == FnKit.interval.Y) { //year
            return Y2 - Y1;
        } else if (interval == FnKit.interval.w) { //week
            ...
            return datediff(FnKit.interval.D, cd1.getTime(), cd2.getTime()) / 7;
        }
