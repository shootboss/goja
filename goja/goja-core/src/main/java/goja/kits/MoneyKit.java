...
public class MoneyKit implements Serializable, Comparable<MoneyKit> {
     ...
     * @param cent 金额分数。
     */
    public MoneyKit(long yuan, int cent) {
     ...
     * @param cent 金额分数。
     */
    public MoneyKit(long yuan, int cent, Currency currency) {
     ...
     * @param currency 币种。
     */
    public MoneyKit(String amount, Currency currency) {
     ...
     */
    public MoneyKit(String amount, Currency currency, int roundingMode) {
     ...
     * @param currency 币种。
     */
    public MoneyKit(double amount, Currency currency) {
        this.currency = currency;
     ...
     * @param amount 金额，以元为单位。
     */
    public MoneyKit(BigDecimal amount) {
        this(amount, Currency.getInstance(DEFAULT_CURRENCY_CODE));
    }
     ...
     * @param roundingMode 取整模式
     */
    public MoneyKit(BigDecimal amount, int roundingMode) {
     ...
     * @param currency 币种
     */
    public MoneyKit(BigDecimal amount, Currency currency) {
     ...
     * @param roundingMode 取整模式。
     */
    public MoneyKit(BigDecimal amount, Currency currency, int roundingMode) {
        this.currency = currency;
    ...
    public boolean equals(Object other) {
        return (other instanceof MoneyKit) && equals((MoneyKit) other);
    }
     ...
     * @return <code>true</code>表示相等，<code>false</code>表示不相等。
     */
    public boolean equals(MoneyKit other) {
     ...
     */
    public int compareTo(MoneyKit other) {
     ...
     * @throws IllegalArgumentException 待比较货币对象与本货币对象的币种不同。
     */
    public boolean greaterThan(MoneyKit other) {
     ...
     * @throws IllegalArgumentException 待比较货币对象与本货币对象的币种不同。
     */
    public boolean greaterThanEquals(MoneyKit other) {
        return compareTo(other) >= 0;
    }
     ...
     * @throws IllegalArgumentException 待比较货币对象与本货币对象的币种不同。
     */
    public boolean lessThan(MoneyKit other) {
        return compareTo(other) < 0;
    }
     ...
     * @throws IllegalArgumentException 待比较货币对象与本货币对象的币种不同。
     */
    public boolean lessThanEquals(MoneyKit other) {
        return compareTo(other) <= 0;
    }
     ...
     */
    public MoneyKit add(MoneyKit other) {
        assertSameCurrencyAs(other);
     ...
     * @throws IllegalArgumentException 如果本货币对象与另一货币对象币种不同。
     */
    public MoneyKit subtract(MoneyKit other) {
        assertSameCurrencyAs(other);
     ...
     * @return 乘法后的结果。
     */
    public MoneyKit multiply(long val) {
     ...
     * @return 相乘后的结果。
     */
    public MoneyKit multiply(double val) {
     ...
     * @return 相乘后的结果。
     */
    public MoneyKit multiply(BigDecimal val) {
     ...
     * @return 相乘后的结果。
     */
    public MoneyKit multiply(BigDecimal val, int roundingMode) {
     ...
     * @return 相除后的结果。
     */
    public MoneyKit divide(double val) {
        return newMoneyWithSameCurrency(Math.round(cent / val));
    }
     ...
     * @return 相除后的结果。
     */
    public MoneyKit divide(BigDecimal val) {
     ...
     * @return 相除后的结果。
     */
    public MoneyKit divide(BigDecimal val, int roundingMode) {
    ...
    public MoneyKit[] allocate(int targets) {
        ...
        MoneyKit lowResult = newMoneyWithSameCurrency(cent / targets);
        MoneyKit highResult = newMoneyWithSameCurrency(lowResult.cent + 1);
     ...
     * @throws IllegalArgumentException 如果本货币对象与另一货币对象币种不同。
     */
    protected void assertSameCurrencyAs(MoneyKit other) {
     ...
     */
    protected MoneyKit newMoneyWithSameCurrency(long cent) {
        MoneyKit money = new MoneyKit(0, currency);
    ...
    public String dump() {
        ...
        return "cent = " + cent + lineSeparator + "currency = " + currency;
    }
