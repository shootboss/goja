...
public class TxtKit {
     ...
     * String log2 = Txt.inject(log, "name", "folier", "无此字段");<br />
     * //执行结果如下：<br />
     * log2="对不起，要更新的字段出错。字段名:name, 字段值:folier, 错误原因:无此字段";
     *
     ...
     * <br /><strong>下面是一个示例性的代码：</strong><br/>
     * String log = "对不起，要更新的字段出错。字段名:?, 字段值:?, 错误原因：?";<br />
     * String log2 = Txt.injectBy(log, "?", "name", "folier", "无此字段");<br />
     * //执行结果如下：<br />
     * log2="对不起，要更新的字段出错。字段名:name, 字段值:folier, 错误原因:无此字段";
     *
     * @param inputString  原始字符串模板.
