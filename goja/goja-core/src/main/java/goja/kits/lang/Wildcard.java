...
public class Wildcard {
    ...
    public static boolean equalsOrMatch(String string, String pattern) {
        return string.equals(pattern) || match(string, pattern, 0, 0);
    }
    ...
    public static boolean matchPath(String path, String pattern) {
        String[] pathElements = CharKit.splitc(path, PATH_SEPARATORS);
        String[] patternElements = CharKit.splitc(pattern, PATH_SEPARATORS);
